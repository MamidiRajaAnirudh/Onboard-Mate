...
def main_app():
    ...
    with tab1:
        ...
        name = st.text_input("Name", placeholder="e.g. ADITHYA/RAJA", key="onboard_name")
        role = st.text_input("Role", placeholder="e.g. Software Engineer", key="onboard_role")
        department = st.text_input("Department", placeholder="e.g. MCA", key="onboard_department")
    ...
    with tab4:
        if st.session_state['user_info']['access_level'] == "admin":
            ...
            with admin_tab3:
                ...
                current_timeout_minutes = st.session_state.session_timeout // 60
                new_timeout_minutes = st.number_input(
                    "Session Timeout (minutes)", 
                    value=current_timeout_minutes, 
                    min_value=1, 
                    max_value=120,
                ...
                if st.button("Save Settings"):
                    ...
                    st.session_state.session_timeout = new_timeout_minutes * 60
